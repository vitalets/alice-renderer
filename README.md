...
Например если фраза заканчивается многоточнием, то многоточние `...` лучше добавить только в текстовый канал.
Многоточние в голосе создаст лишь ненужную паузу в конце.
```js
